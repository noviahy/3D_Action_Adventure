...
public class Health : IDamageable
{
    ...
    {
        if (con.Player.Invincibility && con.ActionState.currentType == ActionState.ActionType.Dodge)
            return;
        else if (con.Player.Invincibility && con.ActionState.currentType == ActionState.ActionType.Parrying)
            return;
        else if (!con.Player.Invincibility && con.ActionState.currentType == ActionState.ActionType.Parrying)
            HP -= value / 2;
        else
